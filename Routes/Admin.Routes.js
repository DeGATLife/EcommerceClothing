module.exports = function(app) {
    //   const router = express.Router()
       var userRoute = require("../Controllers/Admin.Controller");
      var adminMiddleware = require("../Middlewares/Admin.Middleware");
       // User Routes
       app.route('/Admins/Store/Instructor').post(adminMiddleware.auth,userRoute.Store_Insptructor_ByID);
    ...
    //    app.route('/Users/Get/Verify').post(userRoute.User_Verify);
       app.route('/Admins/Get/AllStudents').get(adminMiddleware.auth,userRoute.Get_All_Students);
   };